...
use frontend\components\OnlyWizard\StepEvent;
...
class WizardBehavior extends Behavior
{
    ...
    const IS_SELECT_STEP_PARAM = 'isSelectStep';
    /**
    ...
    protected function nextStep($event = null)
    {
        ...
        if ($event === null) { // first step, resumed wizard, or continuing after an invalid step
            ...
            $params[self::IS_SELECT_STEP_PARAM] = 1;//флаг о ручном выборе параметра
        ...
        $params = array_merge($this->owner->actionParams, $params);
