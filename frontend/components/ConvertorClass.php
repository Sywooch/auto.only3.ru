...
use app\components\simple_html_dom_node;

class ConvertorClass extends Object
{
    ...
    /**
     * Wrapper for $this->htmltodocx_insert_html_recursive()
            ...
            switch ($element->tag) {
                ...
                case 'h6':
                    ...
                    if ($state['structure_document'] && in_array($element->tag, array('h1', 'h2', 'h3', 'h4', 'h5', 'h6')) && is_object($state['phpword_object'])) {
                        ...
                        $phpword_element->addTitle($this->htmltodocx_clean_text($element->innertext), $state['structure_headings'][$element->tag]);
                        break;
                    }
                ...
                case 'a':
                    ...
                    if ($state['context'] == 'section') {
                        ...
                        // document:
                        $state['textrun']->addLink($this->htmltodocx_url_encode_chars($href), $this->htmltodocx_clean_text($element->innertext), $state['current_style']);
                    } else {
